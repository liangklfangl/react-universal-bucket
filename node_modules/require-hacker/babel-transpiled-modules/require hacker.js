...
var require_hacker = {
	...
	global_hook: function global_hook(id, resolve) {
		...
		var resolver = function resolver(required_path, module) {
			// log.debug(`Global require() hook "${id}" fired`)

			// get CommonJS module source code for this require() call
			var resolved = resolve(required_path, module);
			...
			if ((typeof resolved === 'undefined' ? 'undefined' : (0, _typeof3.default)(resolved)) !== 'object') {
	...
	hook: function hook(extension, resolve) {
		...
		_module2.default._extensions[dot_extension] = function (module, filename) {
			...
			(original_loader || _module2.default._extensions['.js'])(module, filename);
		};
