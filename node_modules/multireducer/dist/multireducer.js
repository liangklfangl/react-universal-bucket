(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Multireducer"] = factory();
	else
		root["Multireducer"] = factory();
})(this, function() {
	...
	function wrapDispatch(dispatch, reducerKey) {
	  var wrappedDispatch = function wrappedDispatch(action) {
	    ...
	    if (typeof action === 'function') {
	      wrappedAction = function wrappedAction(globalDispatch, getState, extraArgument) {
	        return action(wrappedDispatch, getState, globalDispatch, reducerKey, extraArgument);
	      };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function bindActionCreators(actionCreators, dispatch, reducerKey) {
...
/***/ function(module, exports) {
	...
	var initAction = { type: '@@multireducer/INIT' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function plainMultireducer(reducers, reducerKey) {
	  ...
	  var initialState = isCustomMountPoint ? reducers(undefined, _initAction2.default) : (0, _mapValues2.default)(reducers, function (reducer) {
	  ...
	  return function () {
	    ...
	    if (action && action.meta && action.meta[_key2.default]) {
	      ...
	      if (reducer) {
	        return _extends({}, state, _defineProperty({}, actionReducerKey, reducer(state[actionReducerKey], action)));
	      }
	    }
